...
(function() {
  ...
  $(document).ready(function() {
    return $('.comment_content_box').mouseover(function() {
      var buttons;
      buttons = $(this).children('.button_to').find('div').children(".delete_button");
      if (buttons.length >= 1) return buttons[0].style.visibility = 'visible';
    });
  });

  $(document).ready(function() {
    return $('.comment_content_box').mouseout(function() {
      var buttons;
      buttons = $(this).children('.button_to').find('div').children(".delete_button");
      if (buttons.length >= 1) return buttons[0].style.visibility = 'hidden';
    });
  });
...
(function() {
  ...
  adjustBoxHeight = function() {
    var boxHeight, containerHeight;
    ...
    return $(".user_stories_container").css({
...
(function() {
  ...
  $(document).ready(function() {
    return $('.short_description_link').click(function() {
